...
class DunamisPage extends StatelessWidget {
  const DunamisPage({super.key});

  Stream<List<Map<String, dynamic>>> recupererDunamis() {
    return FirebaseFirestore.instance
        .collection('categories')
        .where('name', isEqualTo: 'Éditions DUNAMIS')
        .limit(1)
        .snapshots()
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("Éditions DUNAMIS"),
      backgroundColor: Colors.white,),
      body: Padding(
        padding: const EdgeInsets.all(16.0),
        child: StreamBuilder<List<Map<String, dynamic>>>(
          stream: recupererDunamis(),
